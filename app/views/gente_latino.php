...
<body>
    ...
    <section class="bg-cover bg-center bg-no-repeat text-white" style="background-image: url('<?= BASE_URL?>/public/images/positivo-joven-hombre-y-mujer-trabajando-juntos.jpg');">
  <div class="grid md:grid-cols-2 gap-12 bg-[#012030]/80 p-10 md:p-16 w-full h-full">
    ...
    <div class="space-y-6">
      ...
      <p class="text-lg max-w-md">
        Sabemos que estudiar en España puede generar muchas dudas, por eso creamos un <strong class="font-semibold text-white">espacio gratuito</strong> para acompañarte
      </p>
    </div>
    ...
    <div class="space-y-6 mt-16">
      <div class="border-t border-white pt-4">
        ...
        <p class="text-sm">Respondemos tus preguntas en tiempo real y comentamos las dudas más frecuentes que nos dejan en stories de <a href="#" class="underline hover:text-[#9AEBA3]">Instagram</a>.</p>
      </div>
